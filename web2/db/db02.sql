...
(2, '你最常做什麼運動來促進健康體能呢?', 0, 0),
(3, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 2, 5),
(4, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 2, 3),
(5, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 2, 1),
(6, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 2, 2),
...
(10, '孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 7, 1),
(11, '長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 7, 1),
(12, '以上皆是。', 7, 2);
...
(4, 'mem02', 'mem02', 'mem02,mem02@labor.gov.tw');
