...
<body>
	...
	<div id="all">
		<div id="title">
			<?= date(" m 月 d號 l")?> | 今日瀏覽: <?= $Total->find(1)['total'] ?> | 累積瀏覽: <?= $Total->q("select sum(`total`) from `total`")[0][0] ?> <a style="float:right" href="index.php">回首頁</a></div>
		<div id="title2">
			<a href="index.php"><img src="icon/02B01.jpg" alt="健康促進網 - 首頁" title="健康促進網 - 首頁"></a>
		</div>
		<div id="mm">
