...
<body>
	...
	<div id="main">
		<a title="" href="index.php">
				...
				$row = $Title->find(['sh'=>1]);
				?>
					<img src="img/<?=$row['img']?>" title="<?=$row['text']?>" alt="<?=$row['text']?>">
			<!--標題-->
		</a>
		<div id="ms">
				...
				<a style="color:#000; font-size:13px; text-decoration:none;" href="<?=$row['link']?>"><?=$row['text']?></a>
						...
						?>
							<div class="mainmu2 mw">
											<a style="color:#000; font-size:13px; text-decoration:none;" href="<?=$s['link']?>"><?=$s['text']?></a>
							</div>
						<?php
							}
						?>
				...
				<div style="width:89%; height:480px;text-align:center;" class="dbor">
					...
					<div onclick="pp(1)"><img src="icon/up.jpg" alt=""></div>
						...
						foreach($rows as $key => $row){
							echo '<div class="im" id="ssaa'.$key.'"><img src="img/'.$row['img'].'" style="width:150px;height:103px;"></div>';
						}
