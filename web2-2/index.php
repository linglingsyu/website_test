...
<body>
	...
	<div id="all">
		<div id="title">
			...
			echo date("m 月 d 日 l");
			?>
			| 今日瀏覽: <?= $Total->find(['date'=>date("Y-m-d")])['total'] ?> | 累積瀏覽: <?= $Total->q('select sum(`total`) from `total` ')[0][0] ?>
		...
		<div id="mm">
			...
			<div class="hal" id="main">
				<div>
					<div>
						<marquee style="display:inline-block ; width:60%">請民眾踴躍投稿電子報，讓電子報成為大家相互交流、分享的園地！詳見最新文章</marquee>
						<?php

						if (empty($_SESSION['user'])) {
							echo '<a style="display:inline-block ; width:30%" href="?do=login">會員登入</a>';
						} else {
